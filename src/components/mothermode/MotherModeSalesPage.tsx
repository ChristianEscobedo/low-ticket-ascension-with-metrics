...
import { CheckoutHrefProvider } from './parts/CheckoutHrefContext';
 ...
 *
 * checkoutHref: optional override so funnel-builder pages can send CTAs to
 * /funnel/{slug}/checkout instead of the catalog checkout route.
 */
export const MotherModeSalesPage: React.FC<{
  ...
  <CheckoutHrefProvider href={checkoutHref}>
    <div className="min-h-screen bg-bone font-sans text-ink antialiased">
      <UrgencyBar
        category={offer.category}
        urgencyText={
          (offer as { urgencyText?: string }).urgencyText || offer.hero.promise
        }
      />
