              ...
              <div key={f.id} className="rounded-xl border border-bone/10 bg-bone/[0.03] p-4">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2 text-[11px]">
                  ...
                  <button
                    ...
                    disabled={busy}
                    className="ml-auto inline-flex items-center gap-1 rounded-lg border border-red-500/25 px-2.5 py-1.5 text-red-300/70 hover:bg-red-500/10 disabled:opacity-40"
                  >
